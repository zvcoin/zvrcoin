...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zvrcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zvrcointools.com", "dnsseed.zvrcointools.com"},
    {"zvrcoinpool.org", "dnsseed.zvrcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"zvrcointools.com", "testnet-seed.zvrcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zvrcoin is probably already running."), addrBind.ToString().c_str());
        else
